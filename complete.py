...
def sectionSelection(driver, chapter):
	while(True):
		...
		if(section.isnumeric()):
			...
			time.sleep(.5)
			sections = driver.find_elements_by_xpath("/html/body/div[3]/div/div/section[1]/div[2]/ul/li[" + chapter + "]/div[2]/div/div[1]/ul/li[1]/div[1]/a/div/div[1]/span[@class='section-title' and contains(text(), '" + chapter + "')]")
...
def playAnimations(driver):
	animation_players = driver.find_elements_by_xpath("//div[@class='interactive-activity-container animation-player-content-resource participation medium ember-view']")
...
def completeMultipleChoice(driver):
	...
	for question_set in multiple_choice_sets:
		...
		for question in questions:
			choices = question.find_elements_by_xpath("//div[@class='zb-radio-button orange orange ember-view']")
...
def completeShortAnswer(driver):
	...
	for question_set in short_answer_sets:
		...
		for question in questions:
			show_answer_button = question.find_element_by_xpath("//div[@class='show-answer-button zb-button secondary ember-view']")
